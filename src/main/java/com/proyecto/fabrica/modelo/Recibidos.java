...
public class Recibidos {
    ...
    public Recibidos (Date fecha_recibido, Date fecha_entrega, String estado, ArrayList<String> repuestos, String clientes, int precio_final)
    {
    ...
    public int getNumero_de_parte() {
        return numero_de_parte;
    }

    public void setNumero_de_parte(int numero_de_parte) {
